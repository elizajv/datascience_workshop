...
#### Create columns based on language keywords in the "body" and "country" columns, with the latter based on which donor countries have made English an official language
...
rwjAll$English7 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English7 <- str_match(rwjAll$country, "Botswana")
rwjAll$English7 <- ifelse(rwjAll$English7 == "Botswana", 1, 0)
rwjAll$English7 <- unmatrix(rwjAll$English7)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English7[i]=NA
rwjAll$English8 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English8 <- str_match(rwjAll$country, "Cameroon")
rwjAll$English8 <- ifelse(rwjAll$English8 == "Cameroon", 1, 0)
rwjAll$English8 <- unmatrix(rwjAll$English8)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English8[i]=NA
rwjAll$English9 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English9 <- str_match(rwjAll$country, "Gambia")
rwjAll$English9 <- ifelse(rwjAll$English9 == "Gambia", 1, 0)
rwjAll$English9 <- unmatrix(rwjAll$English9)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English9[i]=NA
rwjAll$English10 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English10 <- str_match(rwjAll$country, "Ghana")
rwjAll$English10 <- ifelse(rwjAll$English10 == "Ghana", 1, 0)
rwjAll$English10 <- unmatrix(rwjAll$English10)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English10[i]=NA
rwjAll$English11 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English11 <- str_match(rwjAll$country, "Kenya")
rwjAll$English11 <- ifelse(rwjAll$English11 == "Kenya", 1, 0)
rwjAll$English11 <- unmatrix(rwjAll$English11)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English11[i]=NA
rwjAll$English12 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English12 <- str_match(rwjAll$country, "Lesotho")
rwjAll$English12 <- ifelse(rwjAll$English12 == "Lesotho", 1, 0)
rwjAll$English12 <- unmatrix(rwjAll$English12)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English12[i]=NA
rwjAll$English13 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English13 <- str_match(rwjAll$country, "Liberia")
rwjAll$English13 <- ifelse(rwjAll$English13 == "Liberia", 1, 0)
rwjAll$English13 <- unmatrix(rwjAll$English13)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English13[i]=NA
rwjAll$English14 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English14 <- str_match(rwjAll$country, "Malawi")
rwjAll$English14 <- ifelse(rwjAll$English14 == "Malawi", 1, 0)
rwjAll$English14 <- unmatrix(rwjAll$English14)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English14[i]=NA
rwjAll$English15 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English15 <- str_match(rwjAll$country, "Mauritius")
rwjAll$English15 <- ifelse(rwjAll$English15 == "Mauritius", 1, 0)
rwjAll$English15 <- unmatrix(rwjAll$English15)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English15[i]=NA
rwjAll$English16 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English16 <- str_match(rwjAll$country, "Namibia")
rwjAll$English16 <- ifelse(rwjAll$English16 == "Namibia", 1, 0)
rwjAll$English16 <- unmatrix(rwjAll$English16)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English16[i]=NA
rwjAll$English17 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English17 <- str_match(rwjAll$country, "Nigeria")
rwjAll$English17 <- ifelse(rwjAll$English17 == "Nigeria", 1, 0)
rwjAll$English17 <- unmatrix(rwjAll$English17)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English17[i]=NA
rwjAll$English18 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English18 <- str_match(rwjAll$country, "Rwanda")
rwjAll$English18 <- ifelse(rwjAll$English18 == "Rwanda", 1, 0)
rwjAll$English18 <- unmatrix(rwjAll$English18)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English18[i]=NA
rwjAll$English19 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English19 <- str_match(rwjAll$country, "Saint Helena")
rwjAll$English19 <- ifelse(rwjAll$English19 == "Saint Helena", 1, 0)
rwjAll$English19 <- unmatrix(rwjAll$English19)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English19[i]=NA
rwjAll$English20 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English20 <- str_match(rwjAll$country, "Seychelles")
rwjAll$English20 <- ifelse(rwjAll$English20 == "Seychelles", 1, 0)
rwjAll$English20 <- unmatrix(rwjAll$English20)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English20[i]=NA
rwjAll$English21 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English21 <- str_match(rwjAll$country, "Sierra Leone")
rwjAll$English21 <- ifelse(rwjAll$English21 == "Sierra Leone", 1, 0)
rwjAll$English21 <- unmatrix(rwjAll$English21)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English21[i]=NA
rwjAll$English22 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English22 <- str_match(rwjAll$country, "South Africa")
rwjAll$English22 <- ifelse(rwjAll$English22 == "South Africa", 1, 0)
rwjAll$English22 <- unmatrix(rwjAll$English22)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English22[i]=NA
rwjAll$English23 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English23 <- str_match(rwjAll$country, "Swaziland")
rwjAll$English23 <- ifelse(rwjAll$English23 == "Swaziland", 1, 0)
rwjAll$English23 <- unmatrix(rwjAll$English23)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English23[i]=NA
rwjAll$English24 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English24 <- str_match(rwjAll$country, "Uganda")
rwjAll$English24 <- ifelse(rwjAll$English24 == "Uganda", 1, 0)
rwjAll$English24 <- unmatrix(rwjAll$English24)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English24[i]=NA
rwjAll$English25 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English25 <- str_match(rwjAll$country, "Zambia")
rwjAll$English25 <- ifelse(rwjAll$English25 == "Zambia", 1, 0)
rwjAll$English25 <- unmatrix(rwjAll$English25)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English25[i]=NA
rwjAll$English26 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English26 <- str_match(rwjAll$country, "Zimbabwe")
rwjAll$English26 <- ifelse(rwjAll$English26 == "Zimbabwe", 1, 0)
rwjAll$English26 <- unmatrix(rwjAll$English26)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English26[i]=NA
rwjAll$English27 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English27 <- str_match(rwjAll$country, "Anguilla")
rwjAll$English27 <- ifelse(rwjAll$English27 == "Anguilla", 1, 0)
rwjAll$English27 <- unmatrix(rwjAll$English27)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English27[i]=NA
rwjAll$English28 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English28 <- str_match(rwjAll$country, "Antigua and Barbuda")
rwjAll$English28 <- ifelse(rwjAll$English28 == "Antigua and Barbuda", 1, 0)
rwjAll$English28 <- unmatrix(rwjAll$English28)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English28[i]=NA
rwjAll$English29 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English29 <- str_match(rwjAll$country, "Barbados")
rwjAll$English29 <- ifelse(rwjAll$English29 == "Barbados", 1, 0)
rwjAll$English29 <- unmatrix(rwjAll$English29)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English29[i]=NA
rwjAll$English30 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English30 <- str_match(rwjAll$country, "Belize")
rwjAll$English30 <- ifelse(rwjAll$English30 == "Belize", 1, 0)
rwjAll$English30 <- unmatrix(rwjAll$English30)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English30[i]=NA
rwjAll$English31 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English31 <- str_match(rwjAll$country, "Dominica")
rwjAll$English31 <- ifelse(rwjAll$English31 == "Dominica", 1, 0)
rwjAll$English31 <- unmatrix(rwjAll$English31)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English31[i]=NA
rwjAll$English32 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English32 <- str_match(rwjAll$country, "Grenada")
rwjAll$English32 <- ifelse(rwjAll$English32 == "Grenada", 1, 0)
rwjAll$English32 <- unmatrix(rwjAll$English32)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English32[i]=NA
rwjAll$English33 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English33 <- str_match(rwjAll$country, "Guyana")
rwjAll$English33 <- ifelse(rwjAll$English33 == "Guyana", 1, 0)
rwjAll$English33 <- unmatrix(rwjAll$English33)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English33[i]=NA
rwjAll$English34 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English34 <- str_match(rwjAll$country, "Jamaica")
rwjAll$English34 <- ifelse(rwjAll$English34 == "Jamaica", 1, 0)
rwjAll$English34 <- unmatrix(rwjAll$English34)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English34[i]=NA
rwjAll$English35 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English35 <- str_match(rwjAll$country, "Saint Lucia")
rwjAll$English35 <- ifelse(rwjAll$English35 == "Saint Lucia", 1, 0)
rwjAll$English35 <- unmatrix(rwjAll$English35)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English35[i]=NA
rwjAll$English36 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English36 <- str_match(rwjAll$country, "Trinidad and Tobago")
rwjAll$English36 <- ifelse(rwjAll$English36 == "Trinidad and Tobago", 1, 0)
rwjAll$English36 <- unmatrix(rwjAll$English36)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English36[i]=NA
rwjAll$English37 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English37 <- str_match(rwjAll$country, "Brunei")
rwjAll$English37 <- ifelse(rwjAll$English37 == "Brunei", 1, 0)
rwjAll$English37 <- unmatrix(rwjAll$English37)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English37[i]=NA
rwjAll$English38 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English38 <- str_match(rwjAll$country, "India")
rwjAll$English38 <- ifelse(rwjAll$English38 == "India", 1, 0)
rwjAll$English38 <- unmatrix(rwjAll$English38)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English38[i]=NA
rwjAll$English39 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English39 <- str_match(rwjAll$country, "Pakistan")
rwjAll$English39 <- ifelse(rwjAll$English39 == "Pakistan", 1, 0)
rwjAll$English39 <- unmatrix(rwjAll$English39)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English39[i]=NA
rwjAll$English40 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English40 <- str_match(rwjAll$country, "Philippines")
rwjAll$English40 <- ifelse(rwjAll$English40 == "Philippines", 1, 0)
rwjAll$English40 <- unmatrix(rwjAll$English40)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English40[i]=NA
rwjAll$English41 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English41 <- str_match(rwjAll$country, "Singapore")
rwjAll$English41 <- ifelse(rwjAll$English41 == "Singapore", 1, 0)
rwjAll$English41 <- unmatrix(rwjAll$English41)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English41[i]=NA
rwjAll$English42 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English42 <- str_match(rwjAll$country, "Sri Lanka")
rwjAll$English42 <- ifelse(rwjAll$English42 == "Sri Lanka", 1, 0)
rwjAll$English42 <- unmatrix(rwjAll$English42)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English42[i]=NA
rwjAll$English43 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English43 <- str_match(rwjAll$country, "Fiji")
rwjAll$English43 <- ifelse(rwjAll$English43 == "Fiji", 1, 0)
rwjAll$English43 <- unmatrix(rwjAll$English43)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English43[i]=NA
rwjAll$English44 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English44 <- str_match(rwjAll$country, "Kiribati")
rwjAll$English44 <- ifelse(rwjAll$English44 == "Kiribati", 1, 0)
rwjAll$English44 <- unmatrix(rwjAll$English44)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English44[i]=NA
rwjAll$English45 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English45 <- str_match(rwjAll$country, "Marshall Islands")
rwjAll$English45 <- ifelse(rwjAll$English45 == "Marshall Islands", 1, 0)
rwjAll$English45 <- unmatrix(rwjAll$English45)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English45[i]=NA
rwjAll$English46 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English46 <- str_match(rwjAll$country, "Micronesia")
rwjAll$English46 <- ifelse(rwjAll$English46 == "Micronesia", 1, 0)
rwjAll$English46 <- unmatrix(rwjAll$English46)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English46[i]=NA
rwjAll$English47 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English47 <- str_match(rwjAll$country, "Nauru")
rwjAll$English47 <- ifelse(rwjAll$English47 == "Nauru", 1, 0)
rwjAll$English47 <- unmatrix(rwjAll$English47)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English47[i]=NA
rwjAll$English48 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English48 <- str_match(rwjAll$country, "New Zealand")
rwjAll$English48 <- ifelse(rwjAll$English48 == "New Zealand", 1, 0)
rwjAll$English48 <- unmatrix(rwjAll$English48)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English48[i]=NA
rwjAll$English49 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English49 <- str_match(rwjAll$country, "Palau")
rwjAll$English49 <- ifelse(rwjAll$English49 == "Palau", 1, 0)
rwjAll$English49 <- unmatrix(rwjAll$English49)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English49[i]=NA
rwjAll$English50 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English50 <- str_match(rwjAll$country, "Samoa")
rwjAll$English50 <- ifelse(rwjAll$English50 == "Samoa", 1, 0)
rwjAll$English50 <- unmatrix(rwjAll$English50)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English50[i]=NA
rwjAll$English51 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English51 <- str_match(rwjAll$country, "Solomon Islands")
rwjAll$English51 <- ifelse(rwjAll$English51 == "Solomon Islands", 1, 0)
rwjAll$English51 <- unmatrix(rwjAll$English51)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English51[i]=NA
rwjAll$English52 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English52 <- str_match(rwjAll$country, "Tonga")
rwjAll$English52 <- ifelse(rwjAll$English52 == "Tonga", 1, 0)
rwjAll$English52 <- unmatrix(rwjAll$English52)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English52[i]=NA
rwjAll$English53 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English53 <- str_match(rwjAll$country, "Tuvalu")
rwjAll$English53 <- ifelse(rwjAll$English53 == "Tuvalu", 1, 0)
rwjAll$English53 <- unmatrix(rwjAll$English53)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English53[i]=NA
rwjAll$English54 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English54 <- str_match(rwjAll$country, "Vanuatu")
rwjAll$English54 <- ifelse(rwjAll$English54 == "Vanuatu", 1, 0)
rwjAll$English54 <- unmatrix(rwjAll$English54)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English54[i]=NA
rwjAll$English55 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English55 <- str_match(rwjAll$country, "Papua New Guineau")
rwjAll$English55 <- ifelse(rwjAll$English55 == "Papua New Guineau", 1, 0)
rwjAll$English55 <- unmatrix(rwjAll$English55)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English55[i]=NA
...
rwjAll$bilingual_all <- rowSums(rwjAll[, 19:26], na.rm = TRUE)
rwjAll$bilingual_all[rwjAll$bilingual_all == 2] <- 1
rwjAll$bilingual_all[rwjAll$bilingual_all == 3] <- 1
rwjAll$bilingual_all[rwjAll$bilingual_all == 4] <- 1
rwjAll$bilingual_all[rwjAll$bilingual_all == 5] <- 1
rwjAll$bilingual_all[rwjAll$bilingual_all == 6] <- 1
rwjAll$bilingual_all[rwjAll$bilingual_all == 7] <- 1
rwjAll$bilingual_all[rwjAll$bilingual_all == 8] <- 1
rwjAll$French_Arabic <- rowSums(rwjAll[, 20:21], na.rm = TRUE)
rwjAll$French_Spanish <- rowSums(rwjAll[, c("French", "Spanish")], na.rm = TRUE)
rwjAll$French_Arabic_Spanish <- rowSums(rwjAll[, 20:22], na.rm = TRUE)
...
rwjAll_bil <- filter(rwjAll, bilingual_all == 1)
...
total_EF_16 <- sum(rwjAll_bil16$French, na.rm = TRUE)
...
total_ES_16 <- sum(rwjAll_bil16$Spanish, na.rm = TRUE) 
...
total_EF_15 <- sum(rwjAll_bil15$French, na.rm = TRUE)
...
total_ES_15 <- sum(rwjAll_bil15$Spanish, na.rm = TRUE) 
...
total_EF_14 <- sum(rwjAll_bil14$French, na.rm = TRUE)
...
total_ES_14 <- sum(rwjAll_bil14$Spanish, na.rm = TRUE) 
...
total_EF_13 <- sum(rwjAll_bil13$French, na.rm = TRUE)
...
total_ES_13 <- sum(rwjAll_bil13$Spanish, na.rm = TRUE) 
...
total_EF_12 <- sum(rwjAll_bil12$French, na.rm = TRUE)
...
total_ES_12 <- sum(rwjAll_bil12$Spanish, na.rm = TRUE) 
...
total_EF_11 <- sum(rwjAll_bil11$French, na.rm = TRUE)
...
total_ES_11 <- sum(rwjAll_bil11$Spanish, na.rm = TRUE) 
...
ES_tTest <- t.test(bi_lang_pct$English_Spanish, mu=9)
EC_tTest <- t.test(bi_lang_pct$English_Chinese, mu=1.5)
ER_tTest <- t.test(bi_lang_pct$English_Russian, mu=3)
EP_tTest <- t.test(bi_lang_pct$English_Portuguese, mu=3)
EL_tTest <- t.test(bi_lang_pct$English_local, mu=2)
EFA_tTest <- t.test(bi_lang_pct$English_French_Arabic, mu=40)
EFS_tTest <- t.test(bi_lang_pct$English_French_Spanish, mu=30)
EFAS_tTest <- t.test(bi_lang_pct$English_French_Arabic_Spanish, mu=55)
...
ODA_commitments_French_speaking <- ODA_commitments_11_14[ODA_commitments_11_14$Donor %in% English_donors,]
...
ODA_disbursements_French_speaking <- ODA_disbursements_11_14[ODA_disbursements_11_14$Donor %in% English_donors,]
...
ODA_commitments <- read.csv("C:/Users/elizajv/Documents/ODA_commitments.csv", 1)
ODA_commitments_11_14 <- filter(ODA_commitments, Year >= 2011)
ODA_commitments_Arabic_speaking <- ODA_commitments_11_14[ODA_commitments_11_14$Donor %in% English_donors,]
ODA_commitments_Arabic_speaking <- ODA_commitments_Arabic_speaking[ODA_commitments_Arabic_speaking$Recipient %in% Arabic_speaking_countries,]
...
ODA_disbursements <- read.csv("C:/Users/elizajv/Documents/ODA_disbursements.csv", 1)
ODA_disbursements_11_14 <- filter(ODA_disbursements, Year >= 2011)
ODA_disbursements_Arabic_speaking <- ODA_disbursements_11_14[ODA_disbursements_11_14$Donor %in% English_donors,]
ODA_disbursements_Arabic_speaking <- ODA_disbursements_Arabic_speaking[ODA_disbursements_Arabic_speaking$Recipient %in% Arabic_speaking_countries,]
