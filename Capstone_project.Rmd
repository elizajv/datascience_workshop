...
month <- lapply(type_split, select_el, index = 2) 
day <- lapply(type_split, select_el, index = 3) 
...
rwjobs2016 <- rbind(rwjobs1, rwjobs2, rwjobs3, rwjobs4, rwjobs5, rwjobs6, rwjobs7, rwjobs8, rwjobs9)
