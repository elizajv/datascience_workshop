...
rwjAll$Arabic2 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$Arabic2 <- str_match(rwjAll$body, "arabe") 
rwjAll$Arabic2 <- ifelse(rwjAll$Arabic2=="arabe", 1, 0)
rwjAll$Arabic2 <- unmatrix(rwjAll$Arabic2)
...
rwjAll$Spanish2 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$Spanish2 <- str_match(rwjAll$body, "espagnol") 
rwjAll$Spanish2 <- ifelse(rwjAll$Spanish2=="espagnol", 1, 0)
rwjAll$Spanish2 <- unmatrix(rwjAll$Spanish2)
...
rwjAll$French_Arabic <- rowSums(rwjAll[, c("French", "English2", "Arabic", "Arabic2")], na.rm = TRUE)
rwjAll$French_Arabic[rwjAll$French_Arabic==2] <- 1
rwjAll$French_Arabic[rwjAll$French_Arabic==3] <- 1
rwjAll$French_Arabic[rwjAll$French_Arabic==4] <- 1
...
rwjAll$French_Spanish[rwjAll$French_Spanish==4] <- 1
rwjAll$French_Arabic_Spanish <- rowSums(rwjAll[, c("French", "English2", "Arabic", "Arabic2", "Spanish", "English3")], na.rm = TRUE)
...
rwjAll$French_Arabic_Spanish[rwjAll$French_Arabic_Spanish==5] <- 1
rwjAll$French_Arabic_Spanish[rwjAll$French_Arabic_Spanish==6] <- 1
rwjAll$language_all <- rowSums(rwjAll[, 16:28], na.rm = TRUE)
