...
rwjAll$English56 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English56 <- str_match(rwjAll$country, "Tanzania")
rwjAll$English56 <- ifelse(rwjAll$English56 == "Tanzania", 1, 0)
rwjAll$English56 <- unmatrix(rwjAll$English56)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English56[i]=NA
rwjAll$English57 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English57 <- str_match(rwjAll$country, "Sudan")
rwjAll$English57 <- ifelse(rwjAll$English57 == "Sudan", 1, 0)
rwjAll$English57 <- unmatrix(rwjAll$English57)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English57[i]=NA
rwjAll$English58 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English58 <- str_match(rwjAll$country, "South Sudan")
rwjAll$English58 <- ifelse(rwjAll$English58 == "South Sudan", 1, 0)
rwjAll$English58 <- unmatrix(rwjAll$English58)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English58[i]=NA
rwjAll$English59 <- as.vector(c(NA * nrow(rwjAll)))
rwjAll$English59 <- str_match(rwjAll$country, "Malaysia")
rwjAll$English59 <- ifelse(rwjAll$English59 == "Malaysia", 1, 0)
rwjAll$English59 <- unmatrix(rwjAll$English59)
for (i in 1:length(rwjAll$English1))
if (!is.na(rwjAll$English1[i])) rwjAll$English59[i]=NA
rwjAll$English_total <- rowSums(rwjAll[, 13:71], na.rm = TRUE)
rwjAll$English_total[rwjAll$English_total == 2] <- 1
rwjAll$English_total[rwjAll$English_total == 3] <- 1
rwjAll$English_total[rwjAll$English_total == 4] <- 1
rwjAll$English_total[rwjAll$English_total == 5] <- 1
rwjAll$English_total[rwjAll$English_total == 6] <- 1
rwjAll$English_total[rwjAll$English_total == 7] <- 1
rwjAll$English_total[rwjAll$English_total == 8] <- 1
rwjAll$English_total[rwjAll$English_total == 9] <- 1
rwjAll$English_total[rwjAll$English_total == 10] <- 1
rwjAll$English_total[rwjAll$English_total == 11] <- 1
rwjAll$English_total[rwjAll$English_total == 12] <- 1
rwjAll$English_total[rwjAll$English_total == 13] <- 1
rwjAll$English_total[rwjAll$English_total == 14] <- 1
...
rwjAll$French_Arabic <- rowSums(rwjAll[, c("French", "Arabic")], na.rm = TRUE)
rwjAll$French_Spanish <- rowSums(rwjAll[, c("French", "Spanish")], na.rm = TRUE)
rwjAll$French_Arabic_Spanish <- rowSums(rwjAll[, c("French", "Arabic", "Spanish")], na.rm = TRUE)
...
rwjAll$language_all <- rowSums(rwjAll[, 72:82], na.rm = TRUE)
...
EFA_tTest <- t.test(bi_lang_pct$English_French_Arabic, mu=36)
EFS_tTest <- t.test(bi_lang_pct$English_French_Spanish, mu=28)
EFAS_tTest <- t.test(bi_lang_pct$English_French_Arabic_Spanish, mu=38)
