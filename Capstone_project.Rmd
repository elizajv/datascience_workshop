...
plot1 <- ggplot(ml_comb, aes(x = year, y = percentage, color = bilingual_combination)) +
         ...
         scale_color_discrete(name = "Language combination",
                            ...
                            "English_Chinese"),
                            labels = c("English-French-Arabic-Spanish", "English-French-Arabic", "English-French-Spanish", "English-French", "English-Arabic", "English-Spanish", "English-Portuguese", "English-local", "English-Russian", "English-Chinese")) + 
                            labs(title="Demand for English speakers with foreign language skills\nin global development and humanitarian relief") + 
...
f <- add_sub(plot1, "*Based on 99,310 job ads on Reliefweb", size=8, hjust=1, vjust =1)
ggsave("plot1.jpeg", f))
